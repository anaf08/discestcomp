...
```
Outra maneira de fazermos esses passos é no próprio GitHub, no terceiro quadrante, opção _Git_  e logo depois no botão _Commit_. Abrirá uma nova janela e no lado esquerdo os arquivos que foram alterados, você deve selcionar aqueles que deseja subir para o GitHub, teremos um espaço " _commit message_ " para fazer o comentário. Clicar no botão _Commit_ e depois em _Push_ , finalizado !!! 