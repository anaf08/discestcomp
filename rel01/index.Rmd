...
O objetico de um pacote é facilitar e otimizar atividades do dia-a-dia na utilização da linguagem [R](https://www.r-project.org/), neste caso. Ademais, a experiência de utilizar o pacote possui maior poder de disseminação.


  ![Esqueleto de um pacote](esqueleto.jpg)
